...
namespace CSharp.ApiRequest.Library
{
    public interface IHttpClientRequest
    {
        ...
        Task<TResult> GetAsync<TRequest, TResult>(
            IRequestInfo requestInfo, TRequest body, CancellationToken cancellationToken = default);
        ...
        Task<TResult> PostAsync<TResult>(
            IRequestInfo requestInfo, CancellationToken cancellationToken = default);
        ...
        Task<TResult> DeleteAsync<TResult>(
            IRequestInfo requestInfo, CancellationToken cancellationToken = default);
        Task<TResult> DeleteAsync<TRequest, TResult>(
            IRequestInfo requestInfo, TRequest body, CancellationToken cancellationToken = default);
    }
}
